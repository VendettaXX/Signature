...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.select_hex_file.setGeometry(QtCore.QRect(20, 20, 251, 51))
        ...
        self.create_bin2hash.setEnabled(True)
        self.create_bin2hash.setGeometry(QtCore.QRect(20, 100, 251, 51))
        self.create_bin2hash.setObjectName("create_bin2hash")
        self.clear = QtWidgets.QPushButton(self.centralwidget)
        self.clear.setGeometry(QtCore.QRect(300, 100, 251, 51))
        self.clear.setObjectName("clear")
        self.create_signature_without_key = QtWidgets.QPushButton(self.centralwidget)
        self.create_signature_without_key.setGeometry(QtCore.QRect(300, 20, 251, 51))
        ...
        self.create_signature_using_key.setGeometry(QtCore.QRect(580, 110, 261, 31))
